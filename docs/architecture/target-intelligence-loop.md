...
- M2-ADR-034 — stages 7 and 8. Amendment 1 (2026-09-10) ratified `HYPOTHESIS_UNCERTAINTY_V1` (stage
  ...
  fallback — but authorizes no `V6` code; `V6` itself remains unimplemented. Amendment 4 (2026-09-11)
  corrects Amendment 3 §V only — historical-replay exposure reconstruction from `created_at` alone is
  not exact under concurrent PostgreSQL transactions — and freezes a persisted decision-time
  working-set snapshot as the replacement replay boundary; live `V6` selection is unaffected;
  authorizes no `V6` code or migration. See also `docs/adr/M2-ADR-034-step3-v6-discovery-report.md`
  for the discovery analysis behind Amendment 3, and
  `docs/adr/M2-ADR-034-amendment-4-replay-provenance-discovery.md` for the discovery analysis behind
  Amendment 4.
